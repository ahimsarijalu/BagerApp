  ...
  const uploadImage = async (uri: string) => {
    try {
      ...
      if (!publicUrl) {
        Alert.alert(
          "Error",
          "Failed to retrieve the public URL for the image."
        );
        return;
      }
      ...
      if (user) {
        ...
        if (updateError || updateScoreError) {
          throw updateError || updateScoreError;
        }
    ...
    >
      <ScrollView contentContainerStyle={styles.scrollView}>
        ...
        <View style={styles.fotoProfile}>
          <Image
            source={
              userImage ? { uri: userImage } : require("assets/profilefoto.png")
            }
        ...
        <View style={styles.inputContainer}>
          ...
          <TouchableOpacity onPress={handleSaveChanges}>
            <Image
              source={require("assets/savechange.png")}
